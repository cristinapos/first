...
import {Container, Row, Col, Nav, Tab, TabPane, CardImg} from "react-bootstrap";
                ...
                <Row>
                    ...
                    <Col sm={9} className="secondCol">
                        <TabContent className="mt-3">
                            <TabPane eventKey="first" className="tabPane">
                                <h2 className="text-primary text-md-center">General framework</h2>
                                    <CardImg
                                        className="image"
                                ...
                                <div className="tabPaneText mt-md-4">
                                    <p>This methodology is developed within the CodersLab project.
                                    ...
                                    <p>1) Supporting the participation in continuous professional training of 651 employees from less developed regions, including PFA and II, of which 196 employees will be from rural areas / over 40 years / with low level of qualification; </p>
                                    <p>2) Increasing the level of digital skills for at least 521 employees nationwide, including PFA and II, of which 157 employees will be from rural areas / over 40 years / with low level of qualification, by participating in Coders Lab courses as well as 66 employees who will continue to attend studies / training courses upon termination of participation; </p>
                                    <p>3) Increasing the flexibility on the labor market through professional information, coaching and career development for 651 employees at national level, including PFA and II, of which 196 employees will be from rural areas / over 40 years / with low level of qualification; </p>
                                    <p>4) Improving the employment status for 378 employees at national level by assigning them to a position corresponding to a more advanced qualification at the same employer or at a different employer; </p>
                                </div>
                            </TabPane>
                            <TabPane eventKey="second" className="tabPane">
                                <h2 className="text-primary text-md-center">Aplication domain</h2>
                                    <CardImg
                                        className="image"
                                ...
                                <div className="tabPaneText mt-md-4">
                                    <p>This methodology is intended for use throughout the implementation of the sub-activity.
                                    ...
                                    <p>By accessing the training platform, as well as by the possibility of online access, from any area of the country,
                                    ...
                                    <p>JavaScript courses are expected to run for a period of 4 to 4.5 months, and will be
                            ...
                            <TabPane eventKey="third" className="tabPane">
                                <h2 className="text-primary text-md-center">Course structure </h2>
                                <CardImg
                                    className="image"
                                    src="https://www.trickyenough.com/wp-content/uploads/2020/08/development-scaled.jpg"
                                alt="text"/>
                                <div className="tabPaneText mt-md-4">
                                    <p>The Java Script course is divided into 7 modules: </p>
                                    <p>1. Prework module </p>
                                    <p>2. HTML and CSS module (theory: 17 hours, practice: 23 hours 4- Homework) </p>
                                    <p>3. Javascript module (theory: 14 hours, practice: 26 hours + Homework) </p>
                                    <p>4. Responsive Web Design Module (theory: 15 hours, practice: 25 hours + Homework)</p>
                                    <p>5. ES6 module (theory: 17 hours, practice: 23 hours + Homework) </p>
                                    <p>6. REACT module (theory: 12 hours, practice: 28 hours + Homework) </p>
                                    <p>7. Personal Project Module (practice: 40 hours) </p>
                                </div>
                            </TabPane>
                            <TabPane eventKey="fourth" className="tabPane">
                                <h2 className="text-primary text-md-center">Coordination and development</h2>
                                <CardImg
                                    className="image"
                                    ...
                                    alt="text"/>
                                <div className="tabPaneText mt-md-4">
                                    <p>After signing the training contract each
                                    ...
                                    <p>The stage starts with the transmission of the Preparatory Mode which
                                    ...
                                    <p>The subject consists of a theoretical part and a practical one.
                                    ...
                                    <p>Student progress is monitored by the following
                                    ...
                                    <p>For the preparation of the practical project, a student
                            ...
                            <TabPane eventKey="fifth" className="tabPane">
                                <h2 className="text-primary text-md-center">Organization</h2>
                                <CardImg
                                    className="image"
                                    ...
                                    alt="text"/>
                                <div className="tabPaneText mt-md-4">
                                    <p>The Java Script course is organized by the Ejobs Romania team funded by the European Social Fund.
